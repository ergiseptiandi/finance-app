...
func openAPIComponents() map[string]any {
	...
	mergeOpenAPIComponents(components, walletOpenAPIComponents())
	mergeOpenAPIComponents(components, categoryOpenAPIComponents())
	mergeOpenAPIComponents(components, debtOpenAPIComponents())
	mergeOpenAPIComponents(components, budgetOpenAPIComponents())
...
func requestBodySchema(route routeinfo.RouteInfo) map[string]any {
	...
	if requestBody := walletRequestBodySchema(route); requestBody != nil {
		return requestBody
	}
	...
	if requestBody := budgetRequestBodySchema(route); requestBody != nil {
		return requestBody
	}
...
func responseSchemas(route routeinfo.RouteInfo) map[string]any {
	...
	if responses := walletResponseSchemas(route); responses != nil {
		return responses
	}
	...
	if responses := budgetResponseSchemas(route); responses != nil {
		return responses
	}
...
func parameterSchemas(route routeinfo.RouteInfo) []map[string]any {
	...
	if parameters := budgetParameterSchemas(route); parameters != nil {
		return parameters
	}
