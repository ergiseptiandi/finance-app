	...
	return map[string]any{
		"schemas": map[string]any{
			"NotificationKind": map[string]any{
				"type": "string",
				"enum": []string{"daily_expense_input", "debt_payment", "salary_reminder", "budget_warning", "weekly_summary", "large_transaction", "goal_reminder"},
			},
			...
			"NotificationSettings": map[string]any{
				...
				"properties": map[string]any{
					...
					"salary_day":                        map[string]any{"type": "integer"},
					"budget_amount":                     map[string]any{"type": "number"},
					"budget_warning_enabled":            map[string]any{"type": "boolean"},
					"budget_warning_threshold":          map[string]any{"type": "integer"},
					"weekly_summary_enabled":            map[string]any{"type": "boolean"},
					"weekly_summary_day":                map[string]any{"type": "integer"},
					"large_transaction_enabled":         map[string]any{"type": "boolean"},
					"large_transaction_threshold":       map[string]any{"type": "number"},
					"goal_reminder_enabled":             map[string]any{"type": "boolean"},
					"goal_reminder_days_before":         map[string]any{"type": "integer"},
